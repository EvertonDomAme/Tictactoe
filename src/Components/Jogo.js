...
export default function Jogar() {
    ...
    useEffect(() => {
        ...
        let vencedor = verificaGanhador(itemMatriz);/* vencedor recebe matriz no estado atual para verificar o momento de fazer algo */
        if(vencedor != null) {
    ...
    const elementos = (posicaoLinha, posicaoColuna) => {/* Posição linha clicada e coluna clicada */     
        if(itemMatriz[posicaoLinha][posicaoColuna] == null) {
